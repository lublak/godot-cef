...
```bash
export-cef-dir --version "144.0.13" --force $HOME/.local/share/cef
...
export-cef-dir --version "144.0.13" --target x86_64-apple-darwin --force $HOME/.local/share/cef_x86_64
export CEF_PATH_X64="$HOME/.local/share/cef_x86_64"
export-cef-dir --version "144.0.13" --target aarch64-apple-darwin --force $HOME/.local/share/cef_arm64
...
```powershell
export-cef-dir --version "144.0.13" --force $env:USERPROFILE/.local/share/cef
